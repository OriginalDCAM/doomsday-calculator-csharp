...
namespace DoomsdayCalculatorCore.Main;
    public class DoomsdayCalculator
    {
        ...
        public static int CalculateWeekdayIndex(DateTime dateValue)
        {
        ...
        private static int CalculateTotalYearCorrection(int dateYear)
        {
            ...
            var totalYearCorrection =
                centuryContribution + remainingLastTwoDigits + leapYearCorrection + centuryAnchorDay;
